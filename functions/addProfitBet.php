...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT time_created FROM profitbets WHERE time_created = ?";
        ...
        if ($stmt = mysqli_prepare($link, $sql)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                if (mysqli_stmt_num_rows($stmt) == 1) {                    
                    ...
                    $sql = "UPDATE profitbets SET bookmaker = ?, profit = ? WHERE time_created = ?";
         
                    if ($stmt = mysqli_prepare($link, $sql)) {
                        
                        // Bind variables to the prepared statement as parameters
                        mysqli_stmt_bind_param($stmt, "sds", $param_bookmaker, $param_profit, $param_time_created);
                    ...
                    $sql = "INSERT INTO profitbets (bookmaker, profit, time_created, account) VALUES (?, ?, ?, ?)";
